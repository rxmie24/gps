...
public class NavigationalMap {
	 ...
	 * 
	 * @param start
	 *            the start point of the line to calculate (in meters)
	 * @param end
	 *            the end point of the line to calculate (in meters)
	 * @return A list of points where the given line intersects with the map
	 *         lines. Sorted by distance from the start point.
	 */
	...
	/**
	 * Returns a list of line segments from the map; all start at the given
	 * point.
	 * 
	 * @param point
	 *            The point from which to calculate geometry
	 * @return All the geometry that starts at or passes through this point as
	 *         line segments. The Start member of each line segment will
	 *         satisfy:
	 * 
	 *         {@code VectorUtils.areEqual(point, start);}
	 * 
	 */
	...
	/**
	 * Returns all of the map information in the form of LineSegments. If you
	 * want to do something clever with the geometry yourself, you can use this
	 * method.
	 * 
	 * @return All the data in the loaded map as line segments
	 */
